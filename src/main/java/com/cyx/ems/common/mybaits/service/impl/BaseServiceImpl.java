package com.cyx.ems.common.mybaits.service.impl;

import com.cyx.ems.common.mybaits.entity.Entity;
import com.cyx.ems.common.mybaits.exception.MessageRuntimeException;
import com.cyx.ems.common.mybaits.model.SaveModel;
import com.cyx.ems.common.mybaits.model.TabPage;
import com.cyx.ems.common.mybaits.page.PageUtils;
import com.cyx.ems.common.mybaits.service.BaseService;
...
public abstract class BaseServiceImpl<T extends Entity> implements BaseService<T> {
    ...
    @Override
    @Transactional(isolation = Isolation.READ_COMMITTED, propagation = Propagation.REQUIRED, rollbackFor = {Exception.class})
    public Integer deleteByIds(List<? extends Object> ids){
